...
/**
 * This is the model class for table "v_wyniki_audytorow_cyfrowe2015".
 *
 * The followings are the available columns in table 'v_wyniki_audytorow_cyfrowe2015':
 * @property integer $id
 ...
 */
class VWynikiAudytorowCyfrowe2015 extends CActiveRecord
{
	/**
	...
	{
		return 'v_wyniki_audytorow_cyfrowe2015';
	}
...
//            $sql = "select id, metodaID from audyty";
	 ...
	 * @return VWynikiAudytorowCyfrowe2015 the static model class
	 */
