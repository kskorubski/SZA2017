...
/**
 * This is the model class for table "ankieta_analogowa".
 *
 * The followings are the available columns in table 'ankieta_analogowa':
 * @property integer $id
 ...
 * @property double $x2_2a
 * @property double $x2_2b
 * @property double $x2_3a
 * @property double $x2_3b
 * @property double $x2_4a
 * @property double $x2_4b
 * @property double $x2_5a
 * @property double $x2_5b
 * @property double $x2_6a
 * @property double $x2_6b
 * @property double $x2_7a
 * @property double $x2_7b
 * @property double $x2_9a
 * @property double $x2_9b
 ...
 * @property string $x2_2a_podpowiedz
 * @property string $x2_2b_podpowiedz
 * @property string $x2_3a_podpowiedz
 * @property string $x2_3b_podpowiedz
 * @property string $x2_4a_podpowiedz
 * @property string $x2_4b_podpowiedz
 * @property string $x2_5a_podpowiedz
 * @property string $x2_5b_podpowiedz
 * @property string $x2_6a_podpowiedz
 * @property string $x2_6b_podpowiedz
 * @property string $x2_7a_podpowiedz
 * @property string $x2_7b_podpowiedz
 * @property string $x2_9a_podpowiedz
 * @property string $x2_9b_podpowiedz
 ...
 */
class AnkietaAnalogowa extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'x2_2a_podpowiedz' => 'X2 2a Podpowiedz',
			'x2_2b_podpowiedz' => 'X2 2b Podpowiedz',
			'x2_3a_podpowiedz' => 'X2 3a Podpowiedz',
			'x2_3b_podpowiedz' => 'X2 3b Podpowiedz',
			'x2_4a_podpowiedz' => 'X2 4a Podpowiedz',
			'x2_4b_podpowiedz' => 'X2 4b Podpowiedz',
			'x2_5a_podpowiedz' => 'X2 5a Podpowiedz',
			'x2_5b_podpowiedz' => 'X2 5b Podpowiedz',
			'x2_6a_podpowiedz' => 'X2 6a Podpowiedz',
			'x2_6b_podpowiedz' => 'X2 6b Podpowiedz',
			'x2_7a_podpowiedz' => 'X2 7a Podpowiedz',
			'x2_7b_podpowiedz' => 'X2 7b Podpowiedz',
			'x2_9a_podpowiedz' => 'X2 9a Podpowiedz',
			'x2_9b_podpowiedz' => 'X2 9b Podpowiedz',
	...
	public function search()
	{
		...
		$criteria->compare('x2_2a',$this->x2_2a);
		$criteria->compare('x2_2b',$this->x2_2b);
		$criteria->compare('x2_3a',$this->x2_3a);
		$criteria->compare('x2_3b',$this->x2_3b);
		$criteria->compare('x2_4a',$this->x2_4a);
		$criteria->compare('x2_4b',$this->x2_4b);
		$criteria->compare('x2_5a',$this->x2_5a);
		$criteria->compare('x2_5b',$this->x2_5b);
		$criteria->compare('x2_6a',$this->x2_6a);
		$criteria->compare('x2_6b',$this->x2_6b);
		$criteria->compare('x2_7a',$this->x2_7a);
		$criteria->compare('x2_7b',$this->x2_7b);
		$criteria->compare('x2_9a',$this->x2_9a);
		$criteria->compare('x2_9b',$this->x2_9b);
		...
		$criteria->compare('x2_2a_podpowiedz',$this->x2_2a_podpowiedz,true);
		$criteria->compare('x2_2b_podpowiedz',$this->x2_2b_podpowiedz,true);
		$criteria->compare('x2_3a_podpowiedz',$this->x2_3a_podpowiedz,true);
		$criteria->compare('x2_3b_podpowiedz',$this->x2_3b_podpowiedz,true);
		$criteria->compare('x2_4a_podpowiedz',$this->x2_4a_podpowiedz,true);
		$criteria->compare('x2_4b_podpowiedz',$this->x2_4b_podpowiedz,true);
		$criteria->compare('x2_5a_podpowiedz',$this->x2_5a_podpowiedz,true);
		$criteria->compare('x2_5b_podpowiedz',$this->x2_5b_podpowiedz,true);
		$criteria->compare('x2_6a_podpowiedz',$this->x2_6a_podpowiedz,true);
		$criteria->compare('x2_6b_podpowiedz',$this->x2_6b_podpowiedz,true);
		$criteria->compare('x2_7a_podpowiedz',$this->x2_7a_podpowiedz,true);
		$criteria->compare('x2_7b_podpowiedz',$this->x2_7b_podpowiedz,true);
		$criteria->compare('x2_9a_podpowiedz',$this->x2_9a_podpowiedz,true);
		$criteria->compare('x2_9b_podpowiedz',$this->x2_9b_podpowiedz,true);
	 ...
	 * @return AnkietaAnalogowa the static model class
	 */
