...
/**
 * This is the model class for table "etykieta_analogowa".
 *
 * The followings are the available columns in table 'etykieta_analogowa':
 * @property integer $id
 ...
 * @property integer $x4_16
 * @property integer $x4_17
 * @property integer $x4_18
 * @property integer $x4_19
 * @property integer $x4_20
 ...
 * @property string $x4_16_podpowiedz
 * @property string $x4_17_podpowiedz
 * @property string $x4_18_podpowiedz
 * @property string $x4_19_podpowiedz
 * @property string $x4_20_podpowiedz
 * @property integer $AudytyID
 *
 * The followings are the available model relations:
 * @property Audyty $audyty
 */
class EtykietaAnalogowa extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('x4_1, x4_4, x4_5, x4_6, x4_7, x4_8, x4_9, x4_10, x4_11, x4_12, x4_13, x4_14, x4_15, x4_16, x4_17, x4_18, x4_19, x4_20, AudytyID', 'required'),
			array('x4_1, x4_2, x4_3, x4_4, x4_5, x4_6, x4_7, x4_8, x4_9, x4_10, x4_11, x4_12, x4_13, x4_14, x4_15, x4_16, x4_17, x4_18, x4_19, x4_20, AudytyID', 'numerical', 'integerOnly'=>true),
			array('x4_1_podpowiedz, x4_2_podpowiedz, x4_3_podpowiedz, x4_4_podpowiedz, x4_5_podpowiedz, x4_6_podpowiedz, x4_7_podpowiedz, x4_8_podpowiedz, x4_9_podpowiedz, x4_10_podpowiedz, x4_11_podpowiedz, x4_12_podpowiedz, x4_13_podpowiedz, x4_14_podpowiedz, x4_15_podpowiedz, x4_16_podpowiedz, x4_17_podpowiedz, x4_18_podpowiedz, x4_19_podpowiedz, x4_20_podpowiedz', 'length', 'max'=>150),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, x4_1, x4_2, x4_3, x4_4, x4_5, x4_6, x4_7, x4_8, x4_9, x4_10, x4_11, x4_12, x4_13, x4_14, x4_15, x4_16, x4_17, x4_18, x4_19, x4_20, x4_1_podpowiedz, x4_2_podpowiedz, x4_3_podpowiedz, x4_4_podpowiedz, x4_5_podpowiedz, x4_6_podpowiedz, x4_7_podpowiedz, x4_8_podpowiedz, x4_9_podpowiedz, x4_10_podpowiedz, x4_11_podpowiedz, x4_12_podpowiedz, x4_13_podpowiedz, x4_14_podpowiedz, x4_15_podpowiedz, x4_16_podpowiedz, x4_17_podpowiedz, x4_18_podpowiedz, x4_19_podpowiedz, x4_20_podpowiedz, AudytyID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'x4_16_podpowiedz' => 'X4 16 Podpowiedz',
			'x4_17_podpowiedz' => 'X4 17 Podpowiedz',
			'x4_18_podpowiedz' => 'X4 18 Podpowiedz',
			'x4_19_podpowiedz' => 'X4 19 Podpowiedz',
			'x4_20_podpowiedz' => 'X4 20 Podpowiedz',
			'AudytyID' => 'Audyty',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('x4_16',$this->x4_16);
		$criteria->compare('x4_17',$this->x4_17);
		$criteria->compare('x4_18',$this->x4_18);
		$criteria->compare('x4_19',$this->x4_19);
		$criteria->compare('x4_20',$this->x4_20);
		...
		$criteria->compare('x4_16_podpowiedz',$this->x4_16_podpowiedz,true);
		$criteria->compare('x4_17_podpowiedz',$this->x4_17_podpowiedz,true);
		$criteria->compare('x4_18_podpowiedz',$this->x4_18_podpowiedz,true);
		$criteria->compare('x4_19_podpowiedz',$this->x4_19_podpowiedz,true);
		$criteria->compare('x4_20_podpowiedz',$this->x4_20_podpowiedz,true);
	 ...
	 * @return EtykietaAnalogowa the static model class
	 */
