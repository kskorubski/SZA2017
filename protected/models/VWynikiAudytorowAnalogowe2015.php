...
/**
 * This is the model class for table "v_wyniki_audytorow_analogowe2015".
 *
 * The followings are the available columns in table 'v_wyniki_audytorow_analogowe':
 * @property integer $id
 ...
 */
class VWynikiAudytorowAnalogowe2015 extends CActiveRecord
{
	/**
	...
	{
		return 'v_wyniki_audytorow_analogowe2015';
	}
...
//            $sql = "select id, metodaID from audyty";
	 ...
	 * @return VWynikiAudytorowAnalogowe2015 the static model class
	 */
