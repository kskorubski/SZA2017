...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_2a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_2a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_2b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_2b); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_3a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_3a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_3b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_3b); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_4a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_4a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_4b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_4b); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_5a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_5a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_5b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_5b); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_6a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_6a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_6b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_6b); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_7a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_7a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_7b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_7b); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_8a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_8a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_8b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_8b); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_9a')); ?>:</b>
	<?php echo CHtml::encode($data->x2_9a); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_9b')); ?>:</b>
	<?php echo CHtml::encode($data->x2_9b); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_2_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_2_podpowiedz); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_3_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_3_podpowiedz); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_4_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_4_podpowiedz); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_5_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_5_podpowiedz); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_6_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_6_podpowiedz); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_7_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_7_podpowiedz); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_8_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_8_podpowiedz); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('x2_9_podpowiedz')); ?>:</b>
	<?php echo CHtml::encode($data->x2_9_podpowiedz); ?>
	<br />
