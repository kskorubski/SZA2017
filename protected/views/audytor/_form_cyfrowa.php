...
include 'SlownikPodpowiedziCyfrowa.php';

?>
<h1>Arkusz oceny klinicznej mammogramu - Metoda Cyfrowa</h1>
...
<!--        <div class="row">
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_1a_podpowiedz',array('value'=>'custom value','size'=>123,'maxlength'=>130, 'style'=>'height:50px;')); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_2a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_3a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
    ...
    <td class="tg-s6z2">
		...
		<?php // echo $form->textField($model,'x1_4a', array('size'=>2,'maxlength'=>1)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_4a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_5a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_6a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_7a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
    ...
    <td class="tg-s6z2">
		...
		<?php // echo $form->textField($model,'x1_8a', arra('size'=>2,'maxlength'=>1)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_8a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_9a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_10a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
...
<table class="tg">
  ...
  <tr>
<!--    <td class="tg-nl5m" rowspan="2">Punktacja:<br>0 - duża ilość, uniemożliwia wiarygodną ocenę<br>1 - średnia ilość, wpływa na ocenę<br>2 - mała ilość, nie wpływa na ocenę<br>3 - brak artefaktów</td>-->
      <td class="tg-nl5m" rowspan="2"></td>
  ...
  <tr>
    <td class="tg-031e">Elementy znajdowane na zdjęciu mammograficznym, <br>które nie mają związku ze strukturami<br>  anatomicznymi piersi i/lub występują na kliszy poza obrazem.</td>
    <td class="tg-s6z2" colspan="2">
        <div class="row">
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x2_1a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
    <td class="tg-36xf">Maksymalna liczba punktów</td>
    <td class="tg-ltqa" colspan="2"><b>3</b></td>
    <td class="tg-ltqa" colspan="2"><b>3</b></td>
  </tr>
</table>
     </div>
...
<table class="tg">
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x3_1a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x3_2a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x3_3a_podpowiedz',array('size'=>123,'maxlength'=>130)); ?>
  ...
  <tr>
	...
	<div class="row">
                <?php echo $form->hiddenField($model,'AudytyID', array('value'=>Yii::app()->session['ankieta-id-audytu'])); ?>   
                <?php // echo Yii::app()->session['ankieta-id-audytu']; ?>
	</div>
        <div class="row buttons">
                <?php echo CHtml::submitButton('Zapisz ankietę'); ?>
                <?php 
                if(!$model->isNewRecord){
                     echo CHtml::button('Drukuj', array( 'submit' => Yii::app()->createUrl("/audytor/drukujCyfrowa" , array("id" => $model->id)) ));
                }
                ?>
        ...
        <!--<div id="legenda-ankieta-cyfrowa">-->
        <div id="panel">
        <p><b>LEGENDA:</b></p>

        <b>1. Pozycjonowanie: 0 – 1 pkt</b><br /><br />
        <b>1)</b></b><br />0 pkt – fragment sutka niewidoczny na zdjęciu,<br />
        ...
        <b>2. Ocena artefaktów: 0 – 3 pkt (dotyczy wszystkich parametrów)</b><br />
        ...
        <b>3. Inne parametry: 1 – 5 pkt (dotyczy wszystkich parametrów)</b><br /><br />
        ...
        <b>2) Kontrast – ocenie podlega kontrast pozwalający na odróżnienie struktur anatomicznych tj. elementy gruczołowe, włókniste, naczyniowe:</b><br />
        0 pkt – zła,<br />
        1 pkt – mierna,<br />
        2 pkt – dobra,<br />
        3 pkt – bardzo dobra.<br /><br />
        <b>3) Ostrość – ocenie podlega ostrość granic poszczególnych struktur anatomicznych, tj. zarys skóry, naczyń krwionośnych, tkanki włóknistej, rozetki skórne na tle mięśnia piersiowego:</b><br />
        0 pkt – zła,<br />
        1 pkt – mierna,<br />
        2 pkt – dobra,<br />
        3 pkt – bardzo dobra.<br /><br />
...
//           
            ...
            switch(ktora_kategoria) {
              ...
              $('#x2_1a').change(function() {
                analizuj('2', '#x2_1a', '#x2_1b', null, null, '#x2_1a_podpowiedz', x_2_1_zero, x_2_1_jeden, x_2_1_dwa, null );
                policz1('#x2_1a', null, null, null, null, null, null, null, null,'#wynik_x_2a',null);
              });      
              $('#x2_1b').change(function() {
                analizuj('2', '#x2_1a', '#x2_1b', null, null, '#x2_1a_podpowiedz', x_2_1_zero, x_2_1_jeden, x_2_1_dwa, null );
                policz1('#x2_1b', null, null, null, null, null, null, null, null,'#wynik_x_2b',null);
              });
