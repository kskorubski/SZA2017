...
<div class="container" id="page">
	...
	<div id="header">
		<div id="logo"><?php echo CHtml::encode(Yii::app()->name)." 2017"; ?></div>
                <div id="version"><?php echo "version:2017-07-22_v0001"; ?></div>
	</div><!-- header -->

	<div id="mainMbMenu">
<?php $this->widget('application.extensions.mbmenu.MbMenu',array(
            'items'=>array(
                array('label'=>'Logowanie', 'url'=>array('/glowna/index'), 'visible'=>Yii::app()->user->isGuest),
//                array('label'=>'Logowanie', 'url'=>array('/glowna/index')),
                array('label'=>'Wyloguj ('.Yii::app()->user->name.')', 'url'=>array('/glowna/logout'), 'visible'=>!Yii::app()->user->isGuest),
//                array('label'=>'Debug', 'url'=>array('/glowna/debug')),                
                
//                array('label'=>'Test1', 'url'=>array('/site/contact'),
//                  'items'=>array(
