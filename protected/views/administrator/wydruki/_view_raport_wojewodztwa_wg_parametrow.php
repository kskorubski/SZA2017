...
echo CHtml::button('Drukuj wyniki', array('id'=>'drukuj', 'submit' => Yii::app()->createUrl("/administrator/raport_wojewodztwa_wg_parametrow_drukuj"))); 
echo CHtml::button('Eksport csv', array( 'submit' => Yii::app()->createUrl("/administrator/raport_wojewodztwa_wg_parametrow_csv"))); 



echo "<br />";
echo "<br />";
echo CHtml::button('Pokaż wszystkie', array( 'submit' => Yii::app()->createUrl("/administrator/_view_Raport_wojewodztwa_wg_parametrow_metoda", array("metodaDoRaportu" => "%")))); 
echo CHtml::button('Pokaż cyfrowe', array( 'submit' => Yii::app()->createUrl("/administrator/_view_Raport_wojewodztwa_wg_parametrow_metoda", array("metodaDoRaportu" => "3"))));
echo CHtml::button('Pokaż analogowe', array( 'submit' => Yii::app()->createUrl("/administrator/_view_Raport_wojewodztwa_wg_parametrow_metoda", array("metodaDoRaportu" => "2"))));
