...
echo CHtml::button('Drukuj wyniki', array('id'=>'drukuj', 'submit' => Yii::app()->createUrl("/administrator/raport_wg_parametrow_drukuj", array("nazwa" => $model->nazwa, "miasto" => $model->miasto, "identyfikator_zestawu" => $model->identyfikator_zestawu,"nazwa_wojewodztwa" => $model->nazwa_wojewodztwa, "metodaID" => $model->metodaID, "zaliczenie" => $model->zaliczenie))  )); 
echo CHtml::button('Eksport csv', array( 'submit' => Yii::app()->createUrl("/administrator/raport_wg_parametrow_csv", array("nazwa" => $model->nazwa, "miasto" => $model->miasto, "identyfikator_zestawu" => $model->identyfikator_zestawu,"nazwa_wojewodztwa" => $model->nazwa_wojewodztwa, "metodaID" => $model->metodaID, "zaliczenie" => $model->zaliczenie))  )); 

//echo "test: ".$model->getMyWynikiParametrow();
//echo $model->getMyWynikiParametrow();
...
//                array('text' => '','colspan' => 5, 'options' => array('style' => 'background:white; border-left: 2px solid gray; border-top: 2px solid gray; font-size: 5px; height: 20px;')),
                array('text' => '','colspan' => 5, 'options' => array('style' => 'id="audyty-grid-drukuj_c0"')),
                array('text' => 'Pozycjonowanie','colspan' => 6, 'options' => array('style' => 'background:#6495ED; font-size: 12px;')),
                array('text' => 'Artefakty','colspan' => 6, 'options' => array('style' => 'background: #A9A9A9; font-size: 12px;')),
                array('text' => 'Inne parametry','colspan' => 6, 'options' => array('style' => 'background:#008B8B; font-size: 12px;')),
                array('text' => '','colspan' => 9, 'options' => array('style' => 'id="audyty-grid-drukuj_c0"')),                
                
            ),
            array(
                array('text' => '','colspan' => 5, 'options' => array('style' => 'id="audyty-grid-drukuj_c0"')),
                array('text' => 'Gruczołowe','colspan' => 3, 'options' => array('style' => 'background:#DB7093; font-size: 12px;')),
                array('text' => 'Tłuszczowe','colspan' => 3, 'options' => array('style' => 'background:#CD853F; font-size: 12px;')),
                array('text' => 'Gruczołowe','colspan' => 3, 'options' => array('style' => 'background:#DB7093; font-size: 12px;')),
                array('text' => 'Tłuszczowe','colspan' => 3, 'options' => array('style' => 'background:#CD853F; font-size: 12px;')),
                array('text' => 'Gruczołowe','colspan' => 3, 'options' => array('style' => 'background:#DB7093; font-size: 12px;')),
                array('text' => 'Tłuszczowe','colspan' => 3, 'options' => array('style' => 'background:#CD853F; font-size: 12px;')),
                array('text' => 'Etykieta','colspan' => 3, 'options' => array('style' => 'background:#483D8B; font-size: 12px;')),
                array('text' => '','colspan' => 6, 'options' => array('style' => 'id="audyty-grid-drukuj_c0"')),
            )),
	'id'=>'audyty-grid-parameter',
...
//        'mergeColumns' => array('nazwa_wojewodztwa'),
//        'extraRowPos'=>'above',
...
<script>
    $("#drukuj").click(function(){
        $("#audyty-grid-parameter").addClass("loading");
    });
</script>
