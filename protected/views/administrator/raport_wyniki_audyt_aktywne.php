<h2>Wyniki dla audytów aktywnych.</h2>
<?php



$test = 0;
$dataProvider = $model->raporty_wyniki_lista_aktywne(); 
...
//                ),
            array(
                ...
                'header' => 'Wyniki:',
                'htmlOptions' => array('style'=>'text-align: center;','width'=>'40px'),
//                'value' => 'CHtml::button("Wyniki audytu", array( "submit" => Yii::app()->createUrl("/administrator/drukujWynikiAudytAktywne" , array("id_audytu" => $data->id, "metoda" => $data->metodaID, "status_odwolania" => $data->status_odwolania)) ))',
                'value' => '($data->status_etykiety!=2) ? CHtml::button("Wyniki audytu", array( "submit" => Yii::app()->createUrl("/administrator/drukujWynikiAudytAktywne" , array("id_audytu" => $data->id, "metoda" => $data->metodaID, "status_odwolania" => $data->status_odwolania)) )) : (NULL)',
                ),  
            array(
                'type' => 'raw',
                'header' => 'Ankieta:',
