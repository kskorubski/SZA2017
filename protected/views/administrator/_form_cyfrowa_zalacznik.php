...
<?php 
    ...
    if($status_odwolania == 2){      
        echo "<h3>Załącznik do podsumowania wyników - Metoda Cyfrowa - <b>ODWOŁANIE</b></h3>";
    }else {   
       echo "<h3>Załącznik do podsumowania wyników - Metoda Cyfrowa</h3>";
    }
?>
<!--<h3>Załącznik do podsumowania wyników - Metoda Cyfrowa</h3>-->
