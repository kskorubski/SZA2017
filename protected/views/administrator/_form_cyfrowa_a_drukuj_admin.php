...
<?php 
    ...
    if($status_odwolania == 2){
        echo "<h2>Arkusz oceny klinicznej mammogramu - Metoda Cyfrowa - <b>ODWOŁANIE</b></h2>";
    }else {
       echo "<h2>Arkusz oceny klinicznej mammogramu - Metoda Cyfrowa</h2>"; 
    }
?>
...
.tg .combo{background-color:#26ade4;font-size:13px;color:#444444;text-align:center}
</style>
<table class="tg">
  <tr>
...
<!--        <div class="row">
    ...
    <td class="tg-s6z2">
		...
		<?php // echo $form->textField($model,'x1_1b', array('size'=>2,'maxlength'=>1)); ?>
                <?php // echo $form->dropDownList($model,'x1_1b); ?>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php // echo "Uwagi: ".$form->textField($model,'x1_1a_podpowiedz); ?> 
                <?php echo CHtml::encode("Uwagi: ".$model->x1_1a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_2a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_3a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_4a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_5a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_6a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_7a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_8a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_9a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x1_10a_podpowiedz); ?> 
...
<table class="tg">
  ...
  <tr>
    <td class="tg-nl5m" rowspan="2"><br></td>
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x2_1a_podpowiedz); ?> 
  ...
  <tr>
    <td class="tg-eyl8">Uzyskana liczba punktów</td>
    <td class="tg-ci37" colspan="2"><b><?php echo $model->x2_1a; ?></b></td>
    <td class="tg-ci37" colspan="2"><b><?php echo $model->x2_1b; ?></b></td>
  </tr>
  <tr>
    <td class="tg-36xf">Maksymalna liczba punktów</td>
...
<table class="tg"> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x3_1a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x3_2a_podpowiedz); ?> 
  ...
  <tr>
      <td class="tg-a1rn" colspan="5">
		...
		<?php echo CHtml::encode("Uwagi: ".$model->x3_3a_podpowiedz); ?> 
