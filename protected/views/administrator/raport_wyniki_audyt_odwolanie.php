<h2>Wyniki dla wykonanych odwołań dla audytów.</h2>
<?php



$test = 0;
$dataProvider = $model->raporty_wyniki_lista_odwolanie(); 
...
$grid = $this->widget('zii.widgets.grid.CGridView', array(
	...
	'filter'=> $model,
        ...
        'summaryText'=>'<div id="ksRow"> 
                        <div id="ksLeftColumn"> Tabela nr 2. Zestawy odwołane, wyniki gotowe do druku. </div> 
...
//                ),
            array(
                ...
                'header' => 'Wyniki:',
                'htmlOptions' => array('style'=>'text-align: center;','width'=>'40px'),
                'value' => 'CHtml::button("Wyniki audytu", array( "submit" => Yii::app()->createUrl("/administrator/drukujWynikiAudytOdwolanie" , array("id_audytu" => $data->id, "metoda" => $data->metodaID)) ))',
                ),  
            array(
                'type' => 'raw',
                'header' => 'Ankieta:',
