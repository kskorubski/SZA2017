...
<?php 
    $status_odwolania = Audyty::model()->findByPk(Yii::app()->session['wyniki-cyfrowe-id-audytu'])->status_odwolania; 
    if($status_odwolania == 2){      
        echo "<h3>Podsumowanie wyników oceny mammogramu - metoda cyfrowa - <b>ODWOŁANIE</b></h3>";
    }else {   
       echo "<h3>Podsumowanie wyników oceny mammogramu - metoda cyfrowa</h3>";
    }
?>
<!--<h3>Podsumowanie wyników oceny mammogramu - metoda cyfrowa</h3>-->
<h5>Identyfikator zestawu: <?php echo Audyty::model()->findByPk(Yii::app()->session['wyniki-cyfrowe-id-audytu'])->identyfikator_zestawu; ?></h5>
<br />
<div class="form">
<?php // include_once "TWynikiAudytow.php"; ?>  
<?php // include_once 'TWynikiAudytowTeksty.php'; ?>
<?php $wynikiAudytow = new TWynikiAudytow($model2, $model, 'cyfrowa'); ?>    
<?php 
$id_osrodka = Audyty::model()->findByPk(Yii::app()->session['wyniki-cyfrowe-id-audytu'])->osrodek_id;
...
<table class="tg">
  ...
  <tr>
    <td class="tg-8o21">Maksymalna łączna liczba punktów</td>
    <td class="tg-8o21C"><?php echo $wynikiAudytow->getART_MAX_CYFRA_L(); ?></td>
    <td class="tg-8o21C"><?php echo $wynikiAudytow->getART_MAX_CYFRA_P(); ?></td>
  </tr>
  <tr>
    <td class="tg-yqef">Uzyskana łączna liczba punktów [%]</td>
...
<table class="tg">
  ...
  <tr>
    <td class="tg-8o21">Maksymalna łączna liczba punktów</td>
    <td class="tg-8o21C"><?php echo $wynikiAudytow->getETY_MAX_CYFRA(); ?></td>
  </tr>
  <tr>
    <td class="tg-yqef">Uzyskana łączna liczba punktów [%]</td>
  ...
  <tr>
      <td class="tg-a2rn">
          ...
          <!-- v2017 nie wyswietlamy czy zaliczono -->
            ...
            <br />
            zaliczony - ( >= 77 pkt,  >= 70 %)<br />
            niezaliczony -  ( < 77 pkt,  < 70 %)<br />
      </td> 
      <td class="tg-a3rn">
