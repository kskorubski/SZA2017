...
class ZespolyAudytorowController extends Controller
{
	/**
...
//		);
	...
	{
		$dataProvider=new CActiveDataProvider('ZespolyAudytorow');
	 ...
	 * @return ZespolyAudytorow the loaded model
	 ...
	 * @param ZespolyAudytorow $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='zespoly-audytorow-form')
		{
