...
//		$this->render('rok');
        ...
        public function actionRok2015()
	{
//		$this->render('rok');
            Yii::app()->user->logout();
            $this->redirect('../sza2015/');
	}
        
        public function actionRok2016()
	{
            Yii::app()->user->logout();
            $this->redirect('../sza2016/');
	}
        ...
        public function actionAud_wypelnij_etykiete_cyfrowa()
	{
		...
		if(isset($_POST['EtykietaCyfrowa']))
		{
			...
			if($model->save()){
                        ...
                        //v 2017 zaliczenie etykiety determinuje czy audyt dalej przebiiega
                        //wiec nie mozna na sztywno dac 1 tylko bedzie ona wyliczona
                        //
                            $status_zaliczenia_etykiety = $audyt->etykietaCzyZaliczona($idAudytu, 3);
                            $audyt->status_etykiety = $status_zaliczenia_etykiety;
                            
                            if($status_zaliczenia_etykiety == 2){
                                $audyt->Zespoly_audytorowID = 94; 
                                //TECHICAL ZESPOL potrzebne aby moc wyswietlic 
                                //audyty nie przydzielone do zespolu ale nie zaliczone 
                                // wzgledu na wtykiete
                            }
	...
	{ 
		...
		if(isset($_POST['EtykietaAnalogowa']))
		{
			...
			if($model->save()){
                        ...
                        //wiec nie mozna na sztywno dac 1 tylko bedzie ona wyliczona
                        //
                            $status_zaliczenia_etykiety = $audyt->etykietaCzyZaliczona($idAudytu, 2);
                            $audyt->status_etykiety = $status_zaliczenia_etykiety;
...
//                $audyt->status_etykiety = 1;
                ...
                //------do czyzaliczono
                            ...
                            //słuzy do zwracania wyniku czy etykieta jest zaliczona czy nie 
                            //determinuje o przebiegu audytu                           
                            $status_zaliczenia_etykiety = $audyt->etykietaCzyZaliczona($idAudytu, 3);
                            $audyt->status_etykiety = $status_zaliczenia_etykiety;
                            if($status_zaliczenia_etykiety == 2){
                                $audyt->Zespoly_audytorowID = 94; 
                                //TECHICAL ZESPOL potrzebne aby moc wyswietlic 
                                //audyty nie przydzielone do zespolu ale nie zaliczone 
                                // wzgledu na wtykiete 94 numer technicznego zespolu
                            }else { // jak zwroci 1
                                 $audyt->Zespoly_audytorowID = NULL;
                            }                                                        
